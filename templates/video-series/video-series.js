...
import {
  addDefaultClass, appearMain, createTag, debounce, decorateTables, loadLocalHeader,
} from '../../scripts.js';
...
function generateVideo() {
  if (!document.querySelector('.video-embed-')) return;
  const videos = document.querySelectorAll('.card');

  videos.forEach((video) => {
    const url = video.querySelector('div > a');
